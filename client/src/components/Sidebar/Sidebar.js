  ...
  return (
    <nav className={styles.sidebar__Nav}>
      <div className={styles.sticky}>
        ...
        <ol>
          <a href="/">
            <li className={`${styles.sidebar__li} ${styles.sidebar__q__icon}`}>
              <svg
                aria-hidden="true"
        ...
        <h1 className={styles.sidebar__h1}>
          ...
          <svg aria-hidden="true" className="svg-icon iconInfoSm" width="14" height="14" viewBox="0 0 14 14"><path d="M7 1a6 6 0 1 1 0 12A6 6 0 0 1 7 1Zm1 10V6H6v5h2Zm0-6V3H6v2h2Z"></path></svg>
          </a>
        </h1>
        <ol>
        <li className={`${styles.sidebar__li} ${styles.sidebar__ec__icon}`}>
        ...
        <ol>
        <li className={`${styles.sidebar__li} ${styles.sidebar__cf__icon}`}>
        <a><div className={styles.icon__bg}><svg aria-hidden="true" className="svg-icon iconBriefcaseSm" width="14" height="14" viewBox="0 0 14 14"><path d="M4 3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v1h.5c.83 0 1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5h-7A1.5 1.5 0 0 1 2 10.5v-5C2 4.67 2.67 4 3.5 4H4V3Zm5 1V3H5v1h4Z"></path></svg></div>
              Create free Team</a>
            </li>
        </ol>
      </div>

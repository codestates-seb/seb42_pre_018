        ...
        <div className={cx('d-flex', 'center--main')}>
          ...
          <div className={cx('d-flex', 'form--wrapper')}>
            <div className={cx('buttons', 'd-flex')}>
              <button className={cx('d-flex', 'google')}>
                <svg
                  aria-hidden="true"
              ...
              <button className={cx('d-flex', 'github')}>
                <svg
                  aria-hidden="true"
              ...
              <button className={cx('d-flex', 'facebook')}>
                <svg
                  aria-hidden="true"
            ...
            <div className={cx('form--container')}>
              <form id={cx('signup-form')} className={cx('d-flex')} action="">
                <div className={cx('d-flex', 'signup-box')}>
                  ...
                  <div className={cx('d-flex', 'signup-item')}>
                    ...
                    <p className={cx('hidden')}>이름 에러 메시지</p>
                  </div>
                </div>
                <div className={cx('d-flex', 'signup-box')}>
                ...
                <div className={cx('d-flex', 'signup-box')}>
                  ...
                  <div className={cx('d-flex', 'signup-item')}>
                    ...
                    <p className={cx('pw-caption')}>Passwords must contain at least eight characters, including at least 1 letter and 1 number.</p>
                ...
                <div className={cx('d-flex')}>
                  <div>
                    <input type="checkbox" name="EmailOptIn" id={cx('opt-in')} />
                  </div>
                  <div>
              ...
              <div className={cx('signup-caption')}>
                By clicking &quot;Sign up&quot;, you agree to our <a href="#">terms of service, privacy policy and cookie policy</a>
              </div>
            </div>
          </div>
        </div>

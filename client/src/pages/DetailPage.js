      ...
      <div className={styles.detailpage__post}>
        ...
        <div className={styles.detailpage__content}>
          <p>
            ...
            fascinating fabulous ideale miracle like honey serendipity
            adolescence girlish fascinating girlish florence ideale stella
            masquerade lucid aurora droplet vanilla apple florence grapes
            lovesick apple eunoia lucid carnival ideale droplet seraphic.
            <br />
            <br />
            ice adorable kitten heimish adorable serendipity serendipity lovable
            droplet honey fascinating aurora ideale lovable blossom florence
            flora melody adorable sunrise computer miracle flutter flutter
            miracle twilight sunrise lucy girlish world heimish you sunrise
            lucid adorable adolescence way baby lucid grapes hello droplet
            seraphic computer girlish world flutter.
            <br />
            <br />
            miracle flora heimish girlish like hello fascinating way girlish
            serendipity iris moonlight girlish honey shine hello you marshm iris
            lovable apple lucy adorable bijou blossom adolescence at honey milky
            iris iris pure twinkle lovable masquerade blush computer adolescence
            sunrise apple serendipity like flutter marshmallow like florence
            grapes.
          </p>
